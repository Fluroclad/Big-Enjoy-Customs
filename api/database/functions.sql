DROP FUNCTION IF EXISTS get_player(TEXT);
...
DROP FUNCTION IF EXISTS add_player(JSON);
...
DROP FUNCTION IF EXISTS side(JSON, TEXT);
...
DROP FUNCTION IF EXISTS side(INT);
...
DROP FUNCTION IF EXISTS add_game_team_stats(JSON);
...
DROP FUNCTION IF EXISTS add_game_bans(JSON);
...
DROP FUNCTION IF EXISTS add_game_participants(JSON, JSON);
...
DROP FUNCTION IF EXISTS add_game(JSON, JSON);
